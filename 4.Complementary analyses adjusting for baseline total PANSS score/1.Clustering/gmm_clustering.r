...
# 读取数据
data <- read_xlsx("/Users/zhangtongyi/Desktop/A1论文的数据文档/P0022024-认知聚类-project(最新版）/1.当前最新版本 /3.基线数据分析/2.聚类分析-控制PANSS total/0.数据预处理/2.基于对照的 EF z-score 标准化患者的 EF 值，然后基于对照组得到的回归系数校正患者 EF 值的人口学效应 /结果EF增加回归掉PANSStotal.xlsx", sheet = 1)
